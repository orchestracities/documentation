System.register(['./datasource', './query_ctrl', './config_ctrl'], function(exports_1) {
    ...
    var CrateQueryOptionsCtrl, CrateAnnotationsQueryCtrl;
    return {
        setters:[
        ...
        execute: function() {
            ...
            CrateAnnotationsQueryCtrl = (function () {
                function CrateAnnotationsQueryCtrl() {
                }
                CrateAnnotationsQueryCtrl.templateUrl = 'partials/annotations.editor.html';
                return CrateAnnotationsQueryCtrl;
            })();
            ...
            exports_1("AnnotationsQueryCtrl", CrateAnnotationsQueryCtrl);
        }
    }
});
